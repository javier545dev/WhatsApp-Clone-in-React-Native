        ...
        <Card>
            <View style= {{ height: 70, padding: 3, flexDirection: 'row' }}>
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                    <Avatar.Image source={{uri: props.imgLink }} size={50} 
    ...
    return (
        <View style={{flex:1}}>
            ...
            */}
            ...
            <ActionButton buttonColor="#1abc9c" position= 'right' active={false} size={55} >
                ...
                <ActionButton.Item buttonColor='black' title="All Tasks" onPress={() => {}}>
